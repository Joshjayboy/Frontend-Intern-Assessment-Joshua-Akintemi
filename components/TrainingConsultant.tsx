...
export function TrainingConsultant() {
  return (
    <section className="bg-[#f9f9f9] py-[40px]">
      <div className="py-16 bg-[#e8e1e6]">
        <div className="mx-auto max-w-7xl px-4 md:px-8 flex flex-col gap-6">
          <div>
            <h2 className="font-nunito font-[600] text-[40px] leading-[130%] tracking-[0%] text-[#571244]">
              Training The Consultant
            </h2>
            <p className="font-nunito-sans font-[600] text-[18px] leading-[150%] tracking-[0%] text-[#571244] mt-1">
          ...
          <a
            href="#"
            className="self-start inline-flex items-center gap-2 bg-brand-plum px-6 py-3 text-sm font-medium text-white hover:bg-brand-plum-deep transition-colors rounded-sm"
          >
            Learn More
            <svg
              width="16"
