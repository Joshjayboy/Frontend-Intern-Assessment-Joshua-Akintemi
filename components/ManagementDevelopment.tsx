  ...
  return (
    <section className="py-16 bg-[#f9f9f9]">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="rounded-2xl bg-brand-plum p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1 flex flex-col gap-5">
            <h2 className="font-nunito font-semibold text-[40px] leading-[150%] tracking-[3%] text-white">
              Management Development Program
            </h2>

            <p className="font-nunito-sans font-[400] text-[18px] leading-[150%] tracking-[0%] text-white/80">
            ...
            <ul className="flex flex-col gap-3 mt-2 pl-[16px]">
              {benefits.map((item) => (
                <li
                  key={item}
                  className="flex items-center gap-3 bg-[#8F6182] rounded-md px-4 py-3 text-sm text-white font-nunito-sans"
                >
                  <svg
                    width="16"
                    height="16"
